...
- [X] 点赞功能：用户可以点赞作品，点赞数会实时更新
- [X] 浏览量功能： 每个作品的浏览量会实时更新，用户可以查看作品的浏览量
- [X] 首页排序筛选：支持“最新发布 / 最早发布 / 点赞数最多 / 观看数最多”
- [X] 首页实时统计同步：无需刷新，通过 AJAX 轮询同步各作品点赞与观看数
- [X] 首页样式美化：卡片悬停动效、图片渐进放大、响应式布局优化
